...
let roomTwoComputer = new SetPiece(2, 0, ["\n There is a computer in sleep mode on one of the desks", "\n There is a computer in the room. Its screen reads WNNWWN in a forest green colour"], "computer", (item, textBox) => {
...
const roomThree = new Room(3, "\nYou enter what looks like a hunter's cabin, though one that couldn't have been occupied recently.\nYou see a violent snowstorm raging outside the windows, which are boarded up with planks. \nYou look around the room and see a fireplace, a sofa, a table, and a closet to the West.\nThere is a path to the South", roomThreeCons);
...
const roomFive = new Room(5, "\nYou walk into what looks like a child's room.\nThere is a path to the North, East, and West", roomFiveCons);
const roomSix = new Room(6, "\nYou walk through the door and enter a large spacious banquet hall, adorned with beautiful decorations and elegant furniture.\nThe room is lit by chandeliers hanging from the ceiling, casting a warm and welcoming glow throughout the hall.\nThe centerpiece of the room is a long and ornate dining table, set with a delectable feast that seems to always move just out of reach.\nThere is a path to the South", roomSixCons);
const roomSeven = new Room(7, "\nAs you enter the room, you are transported to the heart of a massive forest.\nAs you step inside, the room dissolves around you and you find yourself standing in a clearing surrounded by towering trees and lush undergrowth.\nThere is a path to the east and west", roomSevenCons);
const roomEight = new Room(8, "\nYou enter what appears to be a gas station that has seen better days as much of the merchandise is secured behind metal bars.\nThe atmosphere in the room is slightly ominous, as the bars seem to suggest a sense of danger or insecurity.\nThere is a path in all directions", roomEightCons);
...
const roomSeventeen = new Room(17, "\n You find yourself still in the forest, upon a clearing with a large boulder in the center.\n Now much deeper into the forest, you feel concerned,\n as if going the wrong direction could leave you lost forever \n You can wander in any direction", roomSeventeenCons);
const roomEighteen = new Room(18, "\n You come upon a small pond deep within the woods, sourced from a stream to the North, dotted by lily pads and cattails.\n You can wander in any direction", roomEighteenCons);
const roomNineteen = new Room(19, "\n The forest continues, the stream flowing from West to South crossing your way.\n You can wander in any direction", roomNineteenCons);
const roomTwenty = new Room(20, "\n The stream's source is a small spring within a rocky outcropping between three large trees.\n You can wander in any direction", roomTwentyCons);
const roomTwentyOne = new Room(21, "\n The forest continues unabated, its rows of towering pines obscuring any attempts to view far into the distance.\n You can wander in any direction", roomTwentyOneCons);
const roomTwentyTwo = new Room(22, "\n After what felt like endless trees and shrubs, you happen upon a small wooden cabin within the heart of the forest, lit from within.\n You can wander in any direction", roomTwentyTwoCons);
