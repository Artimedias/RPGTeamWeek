...
//Defining initial varibles that will be used by everything
...
//Defining setpieces
let roomOneChest = new SetPiece(0, ["There is a locked chest in the room", "There is an already opened chest in the room"], (item) => {
    if(item.name === "Hand")
{
    firstKey.location = 1;
